                                ...
                                <div class="form-body">
                                    <divx class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="ruangan_id" class="form-control" name="ruangan_id" placeholder="Nomor Ruangan">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="kapasitas" class="form-control" name="kapasitas" placeholder="">
                                        </div>
                                        <div class="col-md-4">
