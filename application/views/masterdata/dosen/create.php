                                ...
                                <div class="form-body">
                                    <divx class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="dosen_id" class="form-control" name="dosen_id" placeholder="Nomor dosen">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="nidn" class="form-control" name="nidn" placeholder="">
                                        </div>
                                        <div class="col-md-4">
                                            <label>Nip</label>
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="no_ktp" class="form-control" name="no_ktp" placeholder="">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="gelar_pendidikan" class="form-control" name="gelar_pendidikan" placeholder="">
                                        </div>
                                        <div class="col-md-4">
                                            <label>Alamat</label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="alamat" class="form-control" name="alamat" placeholder="Alamat Lengkap">
                                        </div>
                                        <div class="col-md-4">
                                            <label>No. HP</label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="hp" class="form-control" name="hp" placeholder="">
                                        </div>
                                        <div class="col-md-4">
                                            <label>Email</label>
                                        </div>
